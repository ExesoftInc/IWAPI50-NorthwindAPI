...
namespace NorthwindAPI.Services {
    ...
    public class OrderPluralBuilder : IOrderPluralBuilder {
        ...
        public OrderPluralBuilder(EntitiesContext context, IMapper mapper, ILoggerManager logger) {
            _entities = context;
            _mapper = mapper;
            _logger = logger;
        }
        ...
        private Expression<Func<OrderPlural, OrderPluralModel>>  ProjectToModel {
            get {
                return entity => _mapper.Map<OrderPluralModel>(entity);
            }
        }
        
        public IQueryable<OrderPluralModel> GetOrderPlurals() {
            return _entities.OrderPlurals.Select(ProjectToModel);
        }
        ...
        public async Task<BuilderResponse> GetOrderPlural_ByOrderID(int orderID) {
          var query = await Search(_entities.OrderPlurals, x => x.OrderID == orderID).Select(ProjectToModel)?.ToListAsync();
           ...
           return new BuilderResponse { RequestMessage = $"Record Not Found; OrderPlural with orderID = '{orderID}' doesn't exist." }; 
            }
        }
        
        public IQueryable<OrderPluralModel> GetOrderPlural_ByCustomerID(string customerID) {

          var query = Search(_entities.OrderPlurals, x => x.CustomerID == customerID).Select(ProjectToModel);

            return query;
        }
        
        public IQueryable<OrderPluralModel> GetOrderPlural_ByEmployeeID(int employeeID) {

          var query = Search(_entities.OrderPlurals, x => x.EmployeeID == employeeID).Select(ProjectToModel);

            return query;
        }
        
        public IQueryable<OrderPluralModel> GetOrderPlural_ByShipVia(int shipVia) {

          var query = Search(_entities.OrderPlurals, x => x.ShipVia == shipVia).Select(ProjectToModel);
        ...
        public async Task<BuilderResponse> AddOrderPlural(OrderPluralModel model) {
            if (model.CustomerID != null) {
              ...
              return new BuilderResponse { RequestMessage = $"Foreign Key Violation; " + nameof(model.CustomerID) + " '{model.CustomerID}' doesn't exist in the system."}; 
                }
            }
            ...
            if (model.EmployeeID != null) {
              ...
              return new BuilderResponse { RequestMessage = $"Foreign Key Violation; " + nameof(model.EmployeeID) + " '{model.EmployeeID}' doesn't exist in the system."}; 
                }
            }
            ...
            if (model.ShipVia != null) {
                ...
                if (!matchShipVia.Any()) {
              return new BuilderResponse { RequestMessage = $"Foreign Key Violation; " + nameof(model.ShipVia) + " '{model.ShipVia}' doesn't exist in the system."}; 
                }
            }

           try
           {
                 var entity = _mapper.Map<OrderPlural>(model);
        ...
        public async Task<BuilderResponse> UpdateOrderPlural(OrderPluralModel model) {
          ...
          var query = Search(_entities.OrderPlurals, x =>  x.OrderID == model.OrderID);
            if (!query.Any()) {
              return new BuilderResponse { RequestMessage = "Record Not Found; " + string.Format("OrderPlural with _orderID = '{0}' doesn't exist.",model.OrderID)}; 
            }
            if (model.CustomerID != null) {
                var matchCustomerID = _entities.CustomerPlurals.Where(x => x.CustomerID.Equals(model.CustomerID));
                if (!matchCustomerID.Any()) {
              return new BuilderResponse{ RequestMessage = "Foreign Key Violation; " + nameof(model.CustomerID) + string.Format("OrderPlural with CustomerID = '{0}' doesn't exist.", model.CustomerID)}; 
                }
            }
            ...
            if (model.EmployeeID != null) {
                var matchEmployeeID = _entities.EmployeePlurals.Where(x => x.EmployeeID.Equals(model.EmployeeID));
                if (!matchEmployeeID.Any()) {
              return new BuilderResponse{ RequestMessage = "Foreign Key Violation; " + nameof(model.EmployeeID) + string.Format("OrderPlural with EmployeeID = '{0}' doesn't exist.", model.EmployeeID)}; 
                }
            }
            ...
            if (model.ShipVia != null) {
                var matchShipVia = _entities.ShipperPlurals.Where(x => x.ShipperID.Equals(model.ShipVia));
                if (!matchShipVia.Any()) {
              return new BuilderResponse{ RequestMessage = "Foreign Key Violation; " + nameof(model.ShipVia) + string.Format("OrderPlural with ShipVia = '{0}' doesn't exist.", model.ShipVia)}; 
                }
            }
        ...
        public async Task<BuilderResponse> DeleteOrderPlural(int orderID) {
          var query = Search(_entities.OrderPlurals, x => x.OrderID == orderID);
            if (!query.Any()) {
              return new BuilderResponse { RequestMessage = "Record Not Found; " + string.Format("OrderPlural with _orderID = '{0}' doesn't exist.",orderID)}; 
            }
