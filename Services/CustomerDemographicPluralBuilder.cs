...
namespace NorthwindAPI.Services {
    ...
    public class CustomerDemographicPluralBuilder : ICustomerDemographicPluralBuilder {
        ...
        public CustomerDemographicPluralBuilder(EntitiesContext context, IMapper mapper, ILoggerManager logger) {
            _entities = context;
            _mapper = mapper;
            _logger = logger;
        }
        ...
        private Expression<Func<CustomerDemographicPlural, CustomerDemographicPluralModel>>  ProjectToModel {
            get {
                return entity => _mapper.Map<CustomerDemographicPluralModel>(entity);
            }
        }
        
        public IQueryable<CustomerDemographicPluralModel> GetCustomerDemographicPlurals() {
            return _entities.CustomerDemographicPlurals.Select(ProjectToModel);
        }
        ...
        public async Task<BuilderResponse> GetCustomerDemographicPlural_ByCustomerTypeID(string customerTypeID) {
          var query = await Search(_entities.CustomerDemographicPlurals, x => x.CustomerTypeID == customerTypeID).Select(ProjectToModel)?.ToListAsync();
           ...
           return new BuilderResponse { RequestMessage = $"Record Not Found; CustomerDemographicPlural with customerTypeID = '{customerTypeID}' doesn't exist." }; 
            }
        }
        ...
        public async Task<BuilderResponse> AddCustomerDemographicPlural(CustomerDemographicPluralModel model) {
           try
           {
                 var entity = _mapper.Map<CustomerDemographicPlural>(model);
        ...
        public async Task<BuilderResponse> UpdateCustomerDemographicPlural(CustomerDemographicPluralModel model) {
          ...
          var query = Search(_entities.CustomerDemographicPlurals, x =>  x.CustomerTypeID == model.CustomerTypeID);
            if (!query.Any()) {
              return new BuilderResponse { RequestMessage = "Record Not Found; " + string.Format("CustomerDemographicPlural with _customerTypeID = '{0}' doesn't exist.",model.CustomerTypeID)}; 
            }
           try
           {
        ...
        public async Task<BuilderResponse> DeleteCustomerDemographicPlural(string customerTypeID) {
          var query = Search(_entities.CustomerDemographicPlurals, x => x.CustomerTypeID == customerTypeID);
            if (!query.Any()) {
              return new BuilderResponse { RequestMessage = "Record Not Found; " + string.Format("CustomerDemographicPlural with _customerTypeID = '{0}' doesn't exist.",customerTypeID)}; 
            }
